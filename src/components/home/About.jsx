  ...
  return (
    <section className="w-full px-4 md:px-2 py-20 bg-[#FAFAFA]  overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="w-full bg-[#F3F3F3]/70 rounded-[1.2rem] px-28 py-7 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-md w-full">
            <h2 className="text-3xl md:text-4xl font-medium text-[#262626] mb-6 tracking-tight">
              The 360° <br /> Support Pillar
            </h2>
            <button className="flex items-center gap-3 bg-[#33187F] text-white px-8 py-3.5 rounded-full hover:bg-opacity-90 transition group font-medium whitespace-nowrap">
          ...
          <div className="w-full md:w-auto">
            <ul className="space-y-4 text-[#4B5563] font-medium text-base">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-[40%] flex flex-col text-left">
            <span className="text-[#262626] font-medium text-sm  mb-4">About Us</span>
            <h2 className="text-5xl font-medium text-[#262626] leading-[1.1] mb-8 tracking-tighter text-nowrap font-medium ">
          ...
          <div className="w-full lg:w-[72%] space-y-4 md:space-y-6">
            ...
            <div className="flex gap-4 md:gap-6 w-full">
              {/* Item 1: 40+ */}
              <div className="w-[calc(28%-0.75rem)] bg-[#EEEEEE] rounded-[2rem] p-4 md:p-6 flex flex-col justify-center items-center text-center aspect-[4.5/4.5]">
              ...
              {/* Item 2: Machine */}
              <div className="w-[calc(28%-0.75rem)]  rounded-[2rem] overflow-hidden aspect-[4.5/4.5] relative border border-white border-2">
                <Image src="/home/about1.png" alt="Medical Machine" fill className="object-cover rounded-[2rem] transition-transform hover:scale-110 duration-500 " />
              </div>
            ...
            <div className="flex gap-4 md:gap-6">
              {/* Item 3.9: Spacer */}
              <div className="w-[calc(15%-0.75rem)] rounded-[2.5rem] overflow-hidden aspect-[5/5] relative hidden md:block">
              </div>

              {/* Item 4: Textured Object (about4) */}
              <div className="w-[calc(28%-0.75rem)] rounded-[2rem]  overflow-hidden aspect-[5/5] relative bg-[#EBEBEB] border border-white border-2">
              ...
              {/* Item 5: 10Y */}
              <div className="w-[calc(28%-0.75rem)] bg-[#EEEEEE] rounded-[2rem] p-4 md:p-6 flex flex-col justify-center items-center text-center aspect-[5/5] border border-white border-2">
              ...
              {/* Item 6: Laptop Hands */}
              <div className="w-[calc(28%-0.75rem)] rounded-[2rem]  overflow-hidden aspect-[5/5] relative border border-white border-2">
