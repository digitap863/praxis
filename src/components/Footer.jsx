    ...
    <footer className="w-full px-3 md:px-5 py-10">
      ...
      <div className="mt-8 md:mt-12 max-w-3xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-4 mb-4">
          <Link href="https://www.instagram.com/praxis_edulab?utm_source=qr&igsh=MXRra3Jmd3V4dzNiMw==" target="_blank" rel="noopener noreferrer" className="text-[#311A86] hover:text-[#311A86]/80 transition-colors">
          ...
          <Link href="#" target="_blank" rel="noopener noreferrer" className="text-[#311A86] hover:text-[#311A86]/80 transition-colors">
        ...
        <motion.div 
          ...
          className="bg-[#EEEEEE] border border-gray-100 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm"
        >
        {/* Logo */}
