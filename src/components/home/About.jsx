    ...
    <section className="w-full px-4 md:px-2 py-20 bg-[#FAFAFA]  overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <motion.div 
          ...
          className="w-full bg-[#F3F3F3]/70 rounded-[1.2rem] px-28 py-7 flex flex-col md:flex-row items-center justify-between gap-12"
        >
          ...
          <div className="w-full lg:w-[72%] space-y-4 md:space-y-6">
            ...
            <div className="flex gap-4 md:gap-6 w-full">
              ...
              <motion.div 
                ...
                className="w-[calc(28%-0.75rem)] bg-[#EEEEEE] rounded-[2rem] p-4 md:p-6 flex flex-col justify-center items-center text-center aspect-[4.5/4.5]"
              >
              ...
              <motion.div 
                ...
                className="w-[calc(28%-0.75rem)]  rounded-[2rem] overflow-hidden aspect-[4.5/4.5] relative border border-white border-2"
              >
            ...
            <div className="flex gap-4 md:gap-6">
              ...
              <motion.div 
                ...
                className="w-[calc(28%-0.75rem)] rounded-[2rem]  overflow-hidden aspect-[5/5] relative bg-[#EBEBEB] border border-white border-2"
              >
              ...
              <motion.div 
                ...
                className="w-[calc(28%-0.75rem)] bg-[#EEEEEE] rounded-[2rem] p-4 md:p-6 flex flex-col justify-center items-center text-center aspect-[5/5] border border-white border-2"
              >
              ...
              <motion.div 
                ...
                className="w-[calc(28%-0.75rem)] rounded-[2rem]  overflow-hidden aspect-[5/5] relative border border-white border-2"
              >
